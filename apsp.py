#!/usr/bin/env python
#Not familiar enough with javascript to code up apsp.js
#Here is an alternative I coded up with python

#directed graph is represented as a dictionary
#the shortest path is also represented as a dictionary
#all pairs shortest path is calculated with Dijkstra's algorithm for each individual node as the source
...
if __name__=="__main__":
    ...
    for source in graph.keys():
        ...
        dic1["Node "+source+"'s shortest path to"]=dic2
    print dic1
